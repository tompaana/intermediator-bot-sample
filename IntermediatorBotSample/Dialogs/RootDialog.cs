            ...
            if (!string.IsNullOrEmpty(messageText))
            {
                ...
                else
                {
                    ...
                    messageActivity.Text =
                        $"{string.Format(ConversationText.EchoMessage, messageText)}\n\r"
                        + $"\n\r* {string.Format(ConversationText.OptionsCommandHint, $"{Commands.CommandKeyword} {Commands.CommandListOptions}")}"
