...
{
    public class MyCustomMessageRouterResultHandler : IMessageRouterResultHandler
    {
        /// <summary>
        ...
        protected virtual async Task HandleEngagementChangedResultAsync(MessageRouterResult messageRouterResult)
        {
            ...
            {
                messageToConversationOwner = $"Request from user \"{conversationClientName}\" rejected - that's not nice!";
